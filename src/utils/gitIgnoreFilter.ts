// Code from: https://github.com/gliviu/dir-compare/blob/master/test/extended/gitignoreSupport/gitignoreFilter.ts
// With one modification to fix this: https://github.com/gliviu/dir-compare/issues/76
...
export function getGitignoreFilter(pathLeft: string, pathRight: string): FilterHandler {
    ...
    const gitignoreFilter: FilterHandler = (entry: Entry, relativePath: string, options: Options): boolean => {
        ...
        // Use globby to evaluate the current path, use the relative path
